...
UserSchema.methods.generateAuthToken = function () {
    ...
    var user = this;
    var access = 'auth';
    var token = jwt.sign({_id: user._id.toString(), access}, process.env.JWT_SECRET).toString(); // adding abc123 for salting the token
...
UserSchema.methods.removeToken = function (token) {
    ...
    return user.update({ // return it for making a promise

        $pull: { // pull any instance that matches with this token from the database
